...
from App.views import admin, account

urlpatterns = [
    path('', account.login),
    path('login', account.login),
    path('chart/list', view.chart_list),
    path('chart/', view.home),
    path('chart/admin_list', admin.admin_list),
    path('chart/admin_list/admin_add', admin.admin_add),
